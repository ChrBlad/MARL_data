...
class RewardCalculator:
    ...
    def calculate_reward_Zone1(self, out,actions_to_env,hard_v1,tod):
...
############Price calculation###########################
    ...
    def calculate_reward_Zone2(self, out,actions_to_env,hard_v2,tod):
...
############Price calculation###########################
    ...
    def calculate_reward_Zone3(self, out,actions_to_env,hard_v3,tod):
...
############Price calculation###########################
    ...
    def calculate_reward_Zone4(self, out,actions_to_env,hard_v4,tod):
