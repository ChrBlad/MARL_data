...
if __name__ == "__main__":
    agent_Z1 = Rainbow_1.DQNAgent1(env_Z1,Env_master_script, memory_size, batch_size, target_update, epsilon_decay,n_step=45)
    thread1 = Thread(target=agent_Z1.train, args=(num_frames,))
    agent_Z2 = Rainbow_2.DQNAgent1(env_Z2,agent_Z1,Env_master_script, memory_size, batch_size, target_update, epsilon_decay,n_step=45)
    thread2 = Thread(target=agent_Z2.train, args=(num_frames,))
    agent_Z3 = Rainbow_3.DQNAgent1(env_Z3,agent_Z1,Env_master_script, memory_size, batch_size, target_update, epsilon_decay,n_step=45)
    thread3 = Thread(target=agent_Z3.train, args=(num_frames,))
    agent_Z4 = Rainbow_4.DQNAgent1(env_Z4,agent_Z1,Env_master_script, memory_size, batch_size, target_update, epsilon_decay,n_step=45)
    thread4 = Thread(target=agent_Z4.train, args=(num_frames,))
    agent_mix = Rainbow_mix.DQNAgentmix(env_mixing,agent_Z1,agent_Z2,agent_Z3,agent_Z4,Env_master_script, memory_size, batch_size, target_update, epsilon_decay,n_step=45)
