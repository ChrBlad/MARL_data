...
df_zone1_com['Price']=df_zone1_com['Price']*0.72*0.3*0.1333
df_zone1['Price']=df_zone1['Price']*0.72*0.3*0.1333

df_zone2_com['Price']=df_zone2_com['Price']*0.72*0.3*0.1333
df_zone2['Price']=df_zone2['Price']*0.72*0.3*0.1333

df_zone3_com['Price']=df_zone3_com['Price']*0.72*0.3*0.1333
df_zone3['Price']=df_zone3['Price']*0.72*0.3*0.1333

df_zone4_com['Price']=df_zone4_com['Price']*0.72*0.3*0.1333
df_zone4['Price']=df_zone4['Price']*0.72*0.3*0.1333
...
def Evaluation_of_reward(m,n,SS,n_ref,m_ref,df_zone1,df_zone1_com,reward20,reward20_ref,number,fig_num):
    ...
    plt.plot(X_ref,reward20_ref,label='Traditional Control', alpha=0.7)
    plt.legend()
...
def Evaluation_of_price(m_pr,n_pr,SS,n_pr_ref,m_pr_ref,df_zone1,df_zone1_com,price20,price20_ref,number,fig_num):
    ...
    while m_pr<SS: 
        price20.append(sum(price[n_pr:m_pr]))
        n_pr=n_pr+number
        m_pr=m_pr+number
    
    price_ref = df_zone1_com['Price']
    while m_pr_ref<SS: 
        price20_ref.append(sum(price_ref[n_pr_ref:m_pr_ref]))
    ...
    plt.plot(X_ref,price20_ref,label='Traditional Control', alpha=0.7)
...
f12 = plt.figure(12)
plt.style.use('ggplot')
plt.plot(df_zone1['time'],df_actions['Supplytemp'],label='RL', alpha=0.7)
...
Evaluation_of_error(m,n,SS,n_ref,m_ref,df_zone2,df_zone2_com,error20,error20_ref,number,15)
Evaluation_of_supplytemp(m,n,SS_action,n_ref,m_ref,df_actions,df_actions_com,supplytemp20,supplytemp20_ref,number=number,fig_num=14)
#Evaluation_of_reward(m,n,SS,n_ref,m_ref,df_actions,df_actions_com,reward20,reward20_ref,number,6)
Evaluation_of_duty_cycle(m,n,SS,n_ref,m_ref,df_zone2,df_zone2_com,Valves20,Valves20_ref,number,10)
#Evaluation_of_duty_cycle(m,n,SS,n_ref,m_ref,df_zone2,df_zone2_com,Valves20,Valves20_ref,number,14)
df_zone4["Price"]=(df_zone1["Price"]+df_zone2["Price"]+df_zone3["Price"]+df_zone4["Price"])
df_zone4_com["Price"]=(df_zone1_com["Price"]+df_zone2_com["Price"]+df_zone3_com["Price"]+df_zone4_com["Price"])
#Evaluation_of_duty_cycle(m,n,SS,n_ref,m_ref,df_actions,df_zone2_com,Valves20,Valves20_ref,number,10)
Evaluation_of_Roomtemp(m_t,n_t,SS,n_t_ref,m_t_ref,df_zone1,df_zone1_com,temp20,temp20_ref,number,6)
Evaluation_of_Roomtemp(m_t,n_t,SS,n_t_ref,m_t_ref,df_zone2,df_zone2_com,temp20,temp20_ref,number,7)
Evaluation_of_Roomtemp(m_t,n_t,SS,n_t_ref,m_t_ref,df_zone3,df_zone3_com,temp20,temp20_ref,number,8)
Evaluation_of_Roomtemp(m_t,n_t,SS,n_t_ref,m_t_ref,df_zone4,df_zone4_com,temp20,temp20_ref,number,9)
...
Evaluation_of_reward(m,n,SS,n_ref,m_ref,df_zone2,df_zone2_com,reward20,reward20_ref,number,22)
Evaluation_of_reward(m,n,SS,n_ref,m_ref,df_actions,df_actions_com,reward20,reward20_ref,number,24)

bins_list = [20.5, 20.6, 20.7, 20.8, 20.9, 21, 21.1,21.2,21.3,21.4,21.5,21.6,21.7,21.8,21.9,22,22.1,22.2,22.3,22.4,22.5,22.6,22.7,22.8,22.9,23,23.1,23.2,23.3,23.4,23.5]

#n = math.ceil((df_zone2['Troom'].max() - df_zone2['Troom'].min())/50)


# plt.figure(44)
# df_zone1['Troom'][30000:SS].plot.hist(bins=60,label='MARL', alpha=0.5)
# df_zone1_com['Troom'][30000:SS].plot.hist(bins=60,label='Traditional Control', alpha=0.5)
# plt.xlabel('Temperature[C]')
# plt.legend()

plt.figure(55)
df_zone2['Troom'][30000:SS].plot.hist(bins=bins_list, alpha=0.5)
df_zone2_com['Troom'][30000:SS].plot.hist(bins=bins_list, alpha=0.5)
plt.xlabel('Temperature[C]')
plt.figure(66)
df_zone3['Troom'][30000:SS].plot.hist(bins=bins_list, alpha=0.5)
df_zone3_com['Troom'][30000:SS].plot.hist(bins=bins_list, alpha=0.5)
plt.xlabel('Temperature[C]')
plt.figure(77)
df_zone4['Troom'][30000:SS].plot.hist(bins=bins_list, alpha=0.5)
df_zone4_com['Troom'][30000:SS].plot.hist(bins=bins_list, alpha=0.5)
plt.xlabel('Temperature[C]')
...
data=[df_zone1['Troom'][50000:SS],df_zone1_com['Troom'][50000:SS]]
data11=[df_zone2['Troom'][50000:SS],df_zone2_com['Troom'][50000:SS]]
axs[0].set_title('Zone1')
axs[0].boxplot(data, 0, '')
axs[0].set_ylabel('Tenperature[C]')
axs[0].set_xticklabels(['MARL', 'Traditional Control'])
axs[1].boxplot(data11, 0, '')
axs[1].set_title('Zone2')
axs[1].set_xticklabels(['MARL', 'Traditional Control'])



fig, axs = plt.subplots(1, 2)
data2=[df_zone3['Troom'][30000:SS],df_zone3_com['Troom'][30000:SS]]
data22=[df_zone4['Troom'][30000:SS],df_zone4_com['Troom'][30000:SS]]
axs[0].set_title('Zone3')
axs[0].boxplot(data2, 0, '')
axs[0].set_ylabel('Tenperature[C]')
axs[0].set_xticklabels(['MARL', 'Traditional Control'])
axs[1].boxplot(data22, 0, '')
axs[1].set_title('Zone4')
axs[1].set_xticklabels(['MARL', 'Traditional Control'])
...
# print("meanZ1",df_zone1['Troom'][30000:SS].mean())
# print("varZ1",df_zone1['Troom'][30000:SS].var())
# print("stdZ1",df_zone1['Troom'][30000:SS].std())

# print("meanZ1",df_zone1_com['Troom'][30000:SS].mean())
# print("varZ1",df_zone1_com['Troom'][30000:SS].var())
# print("stdZ1",df_zone1_com['Troom'][30000:SS].std())

# print("meanZ2",df_zone2['Troom'][30000:SS].mean())
# print("varZ2",df_zone2['Troom'][30000:SS].var())
# print("stdZ2",df_zone2['Troom'][30000:SS].std())

# print("meanZ2",df_zone2_com['Troom'][30000:SS].mean())
# print("varZ2",df_zone2_com['Troom'][30000:SS].var())
# print("stdZ2",df_zone2_com['Troom'][30000:SS].std())
# print("stdZ2",stats.sem(df_zone2['Troom'][30000:SS]))
# print("stdZ2",stats.sem(df_zone2_com['Troom'][30000:SS]))
plt.show()
