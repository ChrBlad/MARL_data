...
class AiInputProvider:
    ...
    def calculate_ai_input_Zone1(self, out,actions_to_env,timeofday,Price1,hard_v1):
        ...
        self.last_T1 = T1_std 
        Price1 = Price1
        state = np.array([T1_std, T_amb_std,T_amb_for2_std,diff_amb,Valve1,diff_Room_temp1,T_mix_std,sun_round,sun_for3_std_round,timeofday_std], dtype=float)#Valve1,Hardconstraint/10,T_mix_std,
    ...
    def calculate_ai_input_Zone2(self, out,actions_to_env,timeofday,Price2,hard_v2):
        ...
        self.last_T2 = T2_std 
        Price2 = Price2
        state = np.array([T2_std, T_amb_std,T_amb_for2_std,diff_amb,Valve2,diff_Room_temp2,T_mix_std,sun_round,sun_for3_std_round,timeofday_std], dtype=float)#Valve1,Hardconstraint/10,T_mix_std,
        self.state_list.append(state)
        if len(self.state_list) > 6:
            self.state_list.pop(0)
        if len(self.state_list) < 6:
    ...
    def calculate_ai_input_Zone3(self, out,actions_to_env,timeofday,Price3,hard_v3):
        ...
        self.last_T3 = T3_std 
        Price3 = Price3
        state = np.array([T3_std, T_amb_std,T_amb_for2_std,diff_amb,Valve3,diff_Room_temp3,T_mix_std,sun_round,sun_for3_std_round,timeofday_std], dtype=float)#Valve1,Hardconstraint/10,T_mix_std,
        self.state_list.append(state)
        if len(self.state_list) > 6:
            self.state_list.pop(0)
        if len(self.state_list) < 6:
    ...
    def calculate_ai_input_Zone4(self, out,actions_to_env,timeofday,Price4,hard_v4):
        ...
        self.last_T4 = T4_std 
        Price4 = Price4
        state = np.array([T4_std, T_amb_std,T_amb_for2_std,diff_amb,Valve4,diff_Room_temp4,T_mix_std,sun_round,sun_for3_std_round,timeofday_std], dtype=float)#Valve1,Hardconstraint/10,T_mix_std,
        self.state_list.append(state)
        if len(self.state_list) > 6:
            self.state_list.pop(0)
        if len(self.state_list) < 6:
    ...
    def calculate_ai_input_mix(self, out,actions_to_env,timeofday,Hardconstraint,last_price1,last_price2,last_price3,last_price4):
        ...
        state = np.array([T1_std,T2_std,T3_std,T4_std, T_amb_std,T_amb_for2_std,diff_amb,Valve1,Valve2,Valve3,Valve4,diff_Room_temp1,diff_Room_temp2,diff_Room_temp3,diff_Room_temp4,T_mix_std,Hardconstraint/10,sun_round,sun_for3_std_round,timeofday_std], dtype=float)#Valve1,Hardconstraint/10,T_mix_std,
        self.state_list.append(state)
        if len(self.state_list) > 6:
            self.state_list.pop(0)
        if len(self.state_list) < 6:
