...
df_zone2.columns = ["Troom", "Tamb", "Valve","Power1","Reward","action",'Price','Power','Powerwater','Hcv','tod',"time"]
df_zone3 = pd.DataFrame(data_zone3)
df_zone3.columns = ["Troom", "Tamb", "Valve","Power1","Reward","action",'Price','Power','Powerwater','Hcv','tod',"time"]
df_zone4 = pd.DataFrame(data_zone4)
df_zone4.columns = ["Troom", "Tamb", "Valve","Power1","Reward","action",'Price','Power','Powerwater','Hcv','tod',"time"]
...
Evaluation_of_reward(m,n,SS,n_ref,m_ref,df_zone1,df_zone1_com,reward20,reward20_ref,number,5)
Evaluation_of_reward(m,n,SS,n_ref,m_ref,df_zone2,df_zone2_com,reward20,reward20_ref,number,6)
Evaluation_of_reward(m,n,SS,n_ref,m_ref,df_zone3,df_zone3_com,reward20,reward20_ref,number,7)
Evaluation_of_reward(m,n,SS,n_ref,m_ref,df_zone4,df_zone4_com,reward20,reward20_ref,number,8)
Evaluation_of_reward(m,n,SS,n_ref,m_ref,df_actions,df_actions_com,reward20,reward20_ref,number,9)
