...
with open('output_zone1_NN.csv', 'r') as csvFile:
...
with open('output_zone2_NN.csv', 'r') as csvFile:
    reader = csv.reader(csvFile)
    for row in reader:
...
with open('output_zone3_NN.csv', 'r') as csvFile:
    reader = csv.reader(csvFile)
    for row in reader:
...
csvFile.close()
#####################################################################################################################################
with open('output_zone4_NN.csv', 'r') as csvFile:
    reader = csv.reader(csvFile)
    for row in reader:
...
with open('output_actions_NN.csv', 'r') as csvFile:
    reader = csv.reader(csvFile)
    for row in reader:
...
df_actions_com.columns = ["Valve1", "Supplytemp","Reward","Hardcon","price_reward","sum_mix_reward","change_in_Supply_temp"]#["Valve1", "Supplytemp","Reward"]
...
df_zone1.columns = ["Troom", "Tamb", "Valve","Power1","Reward","action",'Price','Power','Powerwater','Hcv','tod',"time","done"]
df_zone2 = pd.DataFrame(data_zone2)
df_zone2.columns = ["Troom", "Tamb", "Valve","Power1","Reward","action",'Price','Power','Powerwater','Hcv','tod',"time","done"]
df_zone3 = pd.DataFrame(data_zone3)
df_zone3.columns = ["Troom", "Tamb", "Valve","Power1","Reward","action",'Price','Power','Powerwater','Hcv','tod',"time","done"]
df_zone4 = pd.DataFrame(data_zone4)
df_zone4.columns = ["Troom", "Tamb", "Valve","Power1","Reward","action",'Price','Power','Powerwater','Hcv','tod',"time","done"]
#data = float(out['RoomTemperature4']),float(out['Tamb1']),float(out['Valveout4']),float(out['Power4']), float(reward),np.float64(action),np.float64(Price),Power,float(out['Powerwater4']),hard_conV,timeofday_NN,NN_world_simulation_time,done


df_zone1_com = pd.DataFrame(data_zone1_com)
df_zone1_com.columns = ["Troom", "Tamb", "Valve","Power1","Reward","action",'Price','Power','Powerwater','Hcv','tod',"time"]
df_zone2_com = pd.DataFrame(data_zone2_com)
df_zone2_com.columns = ["Troom", "Tamb", "Valve","Power1","Reward","action",'Price','Power','Powerwater','Hcv','tod',"time"]
df_zone3_com = pd.DataFrame(data_zone3_com)
df_zone3_com.columns = ["Troom", "Tamb", "Valve","Power1","Reward","action",'Price','Power','Powerwater','Hcv','tod',"time"]
df_zone4_com = pd.DataFrame(data_zone4_com)
df_zone4_com.columns = ["Troom", "Tamb", "Valve","Power1","Reward","action",'Price','Power','Powerwater','Hcv','tod',"time"]
...
print(df_zone1.head(30))
print(df_zone1_com.head(10))
...
df_zone1['done']=df_zone1['done']+20


f1 = plt.figure(1)
plt.style.use('ggplot')
plt.plot(df_zone1['time'],df_zone1['Troom'],label='RL', alpha=0.7)
plt.plot(df_zone1['time'],df_zone1['done'],label='RL', alpha=0.7)
...
f12 = plt.figure(45)
plt.style.use('ggplot')
plt.plot(df_zone1['time'],df_actions['Supplytemp'],label='Supply', alpha=0.7)
plt.plot(df_zone1['time'],df_zone1['Tamb'],label='Tamb', alpha=0.7)
plt.plot(df_zone1['time'],df_actions['Hardcon'],label='Hardcon_supply', alpha=0.7)
#plt.plot(df_zone1['time'],df_zone1['Hcv']-10,label='HCV', alpha=0.7)
plt.ylabel('Temperature[C]')
plt.xlabel('Time[Days]')
plt.legend()
...
Evaluation_of_duty_cycle(m,n,SS,n_ref,m_ref,df_zone2,df_zone2_com,Valves20,Valves20_ref,number,11)
Evaluation_of_duty_cycle(m,n,SS,n_ref,m_ref,df_zone3,df_zone3_com,Valves20,Valves20_ref,number,12)
Evaluation_of_duty_cycle(m,n,SS,n_ref,m_ref,df_zone4,df_zone4_com,Valves20,Valves20_ref,number,13)
...
#Evaluation_of_reward(m,n,SS,n_ref,m_ref,df_actions,df_zone1_com,reward20,reward20_ref,number,24)
