...
for i in range(6):
    i=i*2
    plot_future(pre_test_list[i+1], y_new_test_list[i])


# model_list[0].save("modelt1")
# model_list[1].save("modelt2")
# model_list[2].save("modelt3")
# model_list[3].save("modelt4")
# model_list[4].save("modelt5")
# model_list[5].save("modelt6")
# model_list[6].save("modelt7")
# model_list[7].save("modelt8")
# model_list[8].save("modelt9")
# model_list[9].save("modelt10")
# model_list[10].save("modelt11")
# model_list[11].save("modelt12")
# model_list[12].save("modelt13")
# model_list[13].save("modelt14")
# model_list[14].save("modelt15")
# model_list[15].save("modelt16")
# model_list[16].save("modelt17")
# model_list[17].save("modelt18")
# model_list[18].save("modelt19")
# model_list[19].save("modelt20")
# model_list[20].save("modelt21")
# model_list[21].save("modelt22")
# model_list[22].save("modelt23")
# model_list[23].save("modelt24")
# model_list[24].save("modelt25")
# model_list[25].save("modelt26")
# model_list[26].save("modelt27")
# model_list[27].save("modelt28")
# model_list[28].save("modelt29")
# model_list[29].save("modelt30")
