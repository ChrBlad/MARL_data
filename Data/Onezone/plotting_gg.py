...
with open('Zone_MARL.csv', 'r') as csvFile:
...
with open('Zone_SARL.csv', 'r') as csvFile:
    reader = csv.reader(csvFile)
    for row in reader:
...
with open('Zone_control_traditional.csv', 'r') as csvFile:
    reader = csv.reader(csvFile)
    for row in reader:
...
df_actions_ref.columns = ["Valve1","Supplytemp","Reward"]#["Valve1",'Valve2', "Supplytemp","Reward"]
