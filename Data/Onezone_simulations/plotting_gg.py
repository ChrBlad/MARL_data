...
df_actions_ref.columns = ["Valve1", "Supplytemp","Reward","Hardcon","price_reward","sum_mix_reward","change_in_Supply_temp"]#["Valve1",'Valve2', "Supplytemp","Reward"]
...
df_actions['Reward']=df_actions['Reward']+df_actions['Hardcon']+df_zone1['Reward']-df_zone1['Hcv']#+df_zone2['Reward']+df_zone3['Reward']+df_zone4['Reward']#+df_actions['Hardcon']#+df_zone2['Reward']
df_actions_com['Reward']=df_actions_com['Reward']+df_actions_com['Hardcon']-df_zone1_com['Hcv']#-df_zone1_com['Reward']-df_actions_com["price_reward"]+3#-df_zone1_com['Hcv']#-df_zone2_com['Reward']-df_zone1_com['Reward']-df_zone3_com['Reward']-df_zone4_com['Reward']#-df_actions_com['price_reward']#+df_zone2_com['Reward']
