...
number=108*10#3240#108#3240#12400#
...
with open('Zone1_MARL.csv', 'r') as csvFile:
...
with open('Zone2_MARL.csv', 'r') as csvFile:
    reader = csv.reader(csvFile)
    for row in reader:
...
with open('Zone3_MARL.csv', 'r') as csvFile:
    reader = csv.reader(csvFile)
    for row in reader:
        data_zone3.append(row)

csvFile.close()
with open('Zone4_MARL.csv', 'r') as csvFile:
    reader = csv.reader(csvFile)
    for row in reader:
...
with open('Zone1_SARL.csv', 'r') as csvFile:
    reader = csv.reader(csvFile)
    for row in reader:
...
with open('Zone2_SARL.csv', 'r') as csvFile:
    reader = csv.reader(csvFile)
    for row in reader:
...
with open('Zone3_SARL.csv', 'r') as csvFile:
    reader = csv.reader(csvFile)
    for row in reader:
...
with open('Zone4_SARL.csv', 'r') as csvFile:
    reader = csv.reader(csvFile)
    for row in reader:
...
with open('Zone1_control_traditional.csv', 'r') as csvFile:
    reader = csv.reader(csvFile)
    for row in reader:
...
with open('Zone2_control_traditional.csv', 'r') as csvFile:
    reader = csv.reader(csvFile)
    for row in reader:
...
with open('Zone3_control_traditional.csv', 'r') as csvFile:
    reader = csv.reader(csvFile)
    for row in reader:
...
with open('Zone4_control_traditional.csv', 'r') as csvFile:
    reader = csv.reader(csvFile)
    for row in reader:
...
with open('Supply_MARL.csv', 'r') as csvFile:
    reader = csv.reader(csvFile)
    for row in reader:
...
with open('Supply_SARL.csv', 'r') as csvFile:
    reader = csv.reader(csvFile)
    for row in reader:
...
with open('Supply_control_traditional.csv', 'r') as csvFile:
    reader = csv.reader(csvFile)
    for row in reader:
...
df_zone1_ref.columns = ["Troom", "Tamb", "Valve","Power1","Reward","action",'Price','Power','Powerwater',"time"]

df_zone2_ref = pd.DataFrame(data_zone2_ref)
df_zone2_ref.columns = ["Troom", "Tamb", "Valve","Power1","Reward","action",'Price','Power','Powerwater',"time"]


df_zone3_ref = pd.DataFrame(data_zone3_ref)
df_zone3_ref.columns = ["Troom", "Tamb", "Valve","Power1","Reward","action",'Price','Power','Powerwater',"time"]

df_zone4_ref = pd.DataFrame(data_zone4_ref)
df_zone4_ref.columns = ["Troom", "Tamb", "Valve","Power1","Reward","action",'Price','Power','Powerwater',"time"]
